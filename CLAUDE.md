...
### ⚠ Woher die Erinnerung „ist schon behoben" kommt — es gibt ZWEI Bild-Wege

Diese App hat **zwei** Wege, über die Bilder hereinkommen, und nur einer war
kaputt:

| Weg | Grenze | verkleinert? |
|---|---|---|
| 📷 **KI-Scan** („Foto aufnehmen", der Kamera-Knopf) | 5 MB | **nein** — wies ab |
| 📎 **KI-Buch** (`kbk*`, „Bilder hinzufügen") | 15 MB | **ja**, seit jeher (`kbkResize`, lange Kante) |

**Klaus' Erinnerung war also nicht falsch, nur am anderen Weg.** Der KI-Buch-Weg
rechnet wirklich herunter und hat es immer getan; der Kamera-Knopf hängt am
KI-Scan. *Zwei Funktionen für dieselbe Sache, zwei Grenzen, zwei Verhalten —
und keine Stelle, an der beides nebeneinander stand.* Muttis Rezeptbuch und
Mein Mixarium haben den KI-Buch-Weg gar nicht (gemessen: null Treffer für
`kbkResize`), dort gab es nur den kaputten.

⚠ **Der KI-Buch-Weg ist NICHT angefasst.** Er deckelt bei 1600 px und 15 MB,
zählt bis 30 Bilder und hat seine eigene gewachsene Begründung. Ihn auf
denselben Deckel zu ziehen wäre eine Änderung ohne Befund — eingereiht, nicht
nebenbei gemacht.
