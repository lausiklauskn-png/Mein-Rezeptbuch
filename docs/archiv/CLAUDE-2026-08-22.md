...
Sie beschrieb im Abschnitt Projektübersicht das FALSCHE Repo (Muttis-Rezeptbuch)
und nannte eine QC-Datei, die es nicht mehr gibt. Beides ist in der geltenden
Fassung (../../CLAUDE.md) geheilt. Netzweites: Sage-Protokol docs/NETZWEIT.md. -->
